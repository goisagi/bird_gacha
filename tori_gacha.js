...
assessmentButton.addEventListener(
  ...
  () => {
    ...
    headerDivision.setAttribute('class', 'class-header text-bg-info text-white py-2 px-3');
    ...
    //resultDivisionにVoostrapのスタイルを適用する
    ...
    anchor.setAttribute('data-url', 'https://goisagi.github.io/bird_gacha/tori_gacha.html');
